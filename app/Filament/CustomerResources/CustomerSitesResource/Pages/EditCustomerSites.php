...
class EditCustomerSites extends EditRecord
{
    ...
    protected function handleRecordUpdate(Model $record, array $data): Model
    {
                        ...
                        foreach ($arr as $key => $value) {
                            if (array_key_exists('id', $value)) {
                                $bankRecord=BankInformations::find($value['id']);
                                ...
                                $bankRecord->customer_id=$value['customer_id'];
                                $bankRecord->update();
                            }
                            else{
                                BankInformations::create([
                                    ...
                                    'has_banking_facilities'=>$value['has_banking_facilities'],
                                    'banking_facilities_details'=>$value['banking_facilities_details'],
                                    'bank_iban'=>$value['bank_iban'],
                                    'bank_swift'=>$value['bank_swift'],
                                    'country_id'=>$value['country_id'],
                                    'currency_id'=>$value['currency_id'],
                                    'bank_preferred'=>$value['bank_preferred'],
