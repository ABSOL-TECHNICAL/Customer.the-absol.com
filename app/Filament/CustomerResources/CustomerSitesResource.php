                                ...
                                ->schema([
                                    Forms\Components\Repeater::make('Bank Information')->label('Bank Information')->schema([
                                        Forms\Components\Select::make('currency_id')
                                            ...
                                            ->preload()
                                            ->live()
                                            ->afterStateUpdated(fn ($state, Forms\Set $set) => $set('bank_code', Bank::find($state)?->bank_code ?? 0))
                                            ->required()
                                            ->createOptionForm([
                                            ...
                                            ->regex('/^[0-9\s]+$/')
                                            ->required(),  
                                            Forms\Components\TextInput::make('bank_status')
                                            ->label('Bank Status')
                                            ->default(1)->readOnly(),
                                        ...
                                        Forms\Components\TextInput::make('bank_holder_name')
                                            ...
                                            ->regex('/^[0-9\s]+$/')
                                            ->required(),
                                            Forms\Components\TextInput::make('branch_status')
                                            ->required()
                                            ->label('Bank Status')
                                            ->default(1)->readOnly(), 
                                            Forms\Components\Select::make('bank_id')
