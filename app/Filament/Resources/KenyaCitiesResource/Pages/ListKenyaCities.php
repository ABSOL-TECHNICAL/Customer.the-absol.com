...
use App\Imports\ImportKenyacities;
use Filament\Actions;
use Filament\Resources\Pages\ListRecords;
use Illuminate\Contracts\View\View;
use Maatwebsite\Excel\Facades\Excel;

class ListKenyaCities extends ListRecords
{
    ...
    public function getHeader(): ?View
    {
        ...
        return view('filament.custom.upload-kenyacities', compact('data'));
    }
    ...
    public function save()
    {
        ...
        try {
            if ($this->file != '') {
                Excel::import(new ImportKenyacities, $this->file);
            }
